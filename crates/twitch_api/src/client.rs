...
use crate::client::request::CachedAuthRequest;
use crate::error::{OidcError, TwitchApiClientError};
use crate::oidc_client::CoreTwitchOidcClient;
...
impl TwitchApiClient {
    ...
    pub async fn new(
        ...
        let issuer = IssuerUrl::new(issuer_url.clone()).map_err(TwitchApiClientError::from)?;
